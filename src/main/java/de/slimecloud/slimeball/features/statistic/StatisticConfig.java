...
public class StatisticConfig extends ConfigCategory {
	...
	@ConfigField(name = "MemberCount Formatierung", command = "member_format", description = "Format für die Mitgliederanzahl-Anzeige. placeholder: %members%", type = ConfigFieldType.STRING)
	private String memberCountFormat = "Total Members: %members%";


	@ConfigField(name = "RoleMemberCount Default Formatierung", command = "default_format", description = "Standard Format für Rollen-Mitgliederanzahl-Anzeigen. placeholders: %role_name%, %members%", type = ConfigFieldType.STRING)
	...
	@ConfigField(name = "RoleMemberCount Formatierung", command = "role_format", description = "Format für die Rollen-Mitgliederanzahl-Anzeigen. placeholders: %role_name%, %members%", type = ConfigFieldType.STRING)
	@Info(keyType = ConfigFieldType.VOICE_CHANNEL)
